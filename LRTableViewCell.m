...
//                    placeholderImage:[LRTableViewCell getDefaultCoverImage]];
}
...
- (void)setArticleTags:(NSArray*)tags target:(id)target action:(SEL)selector
{
    ...
    _systemTagImageView.image = [LRTableViewCell getDefaultTagBgImage];
    ...
    if ([tags count] > 1) {
        ...
        _seriesTagImageView.image = [LRTableViewCell getDefaultTagBgImage];
